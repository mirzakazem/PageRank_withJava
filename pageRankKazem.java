           ...
           // sparse[counter][1]=Integer.parseInt(to)-1;
            ...
            for(int i=0;i<numOfEdges;i++)
            {
                if(deadendsSet.contains((sparse[i][1])+1) )
                 ...
                 //System.out.println("# degree of "+column+" :"+nodesOut.get(column));
            ...
            while(convergence == false && convergenceCounter<150)// keep looping until converge
            {
                //initialze r1 to 0
                ...
                for(int i=0;i<value.length;i++)
                    {
                       ...
                       // r1[row]=((r1[row]+(sumOfDeadends/numOfNodes))*dampingFactor)+((1-dampingFactor)/numOfNodes);
                        r1[row]=(r1[row]*dampingFactor)+((1-dampingFactor)/numOfNodes);
